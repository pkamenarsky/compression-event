// ── Sound system ──
//
// Sound definitions are factory functions that build a fresh AudioNode graph
// each time they are called.  `playSound` wires the graph to the destination
// and returns a handle that can stop it.
//
// Usage:
//   import { playSound, pickup } from './sound';
//   const h = playSound(pickup);
//   // later…
//   h.stop();
