 ...
 * one corner or a deform on one edge was written as. An effect is one amount
 * over its whole ring now, and one set of options: see PLAN-order.
 */
 ...
 */
export function deforming(by: Amount, how: Effecting): Effect {
  return it => {
