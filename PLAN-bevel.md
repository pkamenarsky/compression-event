...
They have moved. `PLAN-effect.md` holds them, along with the design they are
the specification for; this file is the phase-4 plan they were written against,
kept for what it records about the pipeline and the bake.
